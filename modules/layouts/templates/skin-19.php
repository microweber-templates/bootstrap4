...
<section class="section <?php print $layout_classes; ?> fx-deactivate edit safe-mode nodrop" field="layout-skin-19-<?php print $params['id'] ?>" rel="module">
    <div class="container">
