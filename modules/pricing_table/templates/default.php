...
<div class="row pricing-list nodrop safe-mode">
    <?php if ($columns == 4) {
        ...
        $class = 'col-md-offset-2 col-sm-6 col-md-4';
    } else {
    ...
    <?php for ($i = 1; $i <= $columns; $i++): ?>
        <div class=" <?php print $class; ?>">
            <div class="plan  <?php if ($feature == $i): ?>feature<?php endif; ?>">
                <?php if ($feature == $i): ?>
                    <div class="label bestseller edit" rel="module-<?php print $params['id']; ?>" field="label-content-<?php print $i; ?>"><i class="fa fa-star safe-element"></i> <span class="safe-element">Best Seller</span> <i class="fa fa-star safe-element"></i></div>
                <?php endif; ?>
