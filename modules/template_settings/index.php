<?php $theme_color_1 = get_option('theme-color-1', 'mw-template-qtheme'); ?>
<?php $theme_color_2 = get_option('theme-color-2', 'mw-template-qtheme'); ?>
<?php $theme_color_3 = get_option('theme-color-3', 'mw-template-qtheme'); ?>
<?php $theme_color_4 = get_option('theme-color-4', 'mw-template-qtheme'); ?>
<?php $theme_color_5 = get_option('theme-color-5', 'mw-template-qtheme'); ?>
