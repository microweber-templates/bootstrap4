    ...
    <div class="container">
        <div class="m-t-70">
            <?php if ($searchType == 'shop' OR $searchType == ''): ?>
                <h4><em><?php _e('Results found mentioning'); ?></em> &ldquo;<?php print $keywords; ?>&rdquo; <?php _lang("in Shop", "templates/qtheme"); ?></h4>
                <br /><br />
                <div class="row">
            ...
            <?php if ($searchType == 'blog' OR $searchType == ''): ?>
                <h4><em><?php _e('Results found mentioning'); ?></em> &ldquo;<?php print $keywords; ?>&rdquo; <?php _lang("in Blog", "templates/qtheme"); ?></h4>
                <br/>
                <br/>
